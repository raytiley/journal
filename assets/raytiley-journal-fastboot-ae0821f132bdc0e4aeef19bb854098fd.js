define("raytiley-journal/initializers/ajax",["exports"],function(e){"use strict"
...
najax(e)}
e.default={name:"ajax-service",initialize:function(e){e.register("ajax:node",t,{instantiate:!1}),e.inject("adapter","_ajaxRequest","ajax:node"),e.inject("adapter","fastboot","service:fastboot")}}}),define("raytiley-journal/initializers/error-handler",["exports"],function(e){"use strict"
